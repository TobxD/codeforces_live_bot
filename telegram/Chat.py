...
class Chat:
    ...
    def sendMessage(self, text, reply_markup=None, callback=None):
        if self.chatId == "0":
            ...
            tg.requestSpooler.put(
                lambda: tg.sendMessage(self.chatId, text, reply_markup, callback),
                priority=0,
            )
    ...
    def editMessageText(self, msgId, msg, reply_markup=None):
        if self.chatId == "0":
            ...
            tg.requestSpooler.put(
                lambda: tg.editMessageText(self.chatId, msgId, msg, reply_markup),
                priority=0,
            )
    ...
    def deleteMessage(self, msgId):
        if self.chatId == "0":
            ...
            tg.requestSpooler.put(
                lambda: tg.deleteMessage(self.chatId, msgId), priority=1
            )
